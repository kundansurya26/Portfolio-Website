  ...
  return (
    <section id="certifications" ref={ref} className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <p className="font-mono text-brand-400 text-xs tracking-widest uppercase mb-3">What I've Earned</p>
          ...
          {certifications.map((cert, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-slate-500 text-xs font-mono uppercase tracking-widest mb-1">{cert.issuer}</p>
