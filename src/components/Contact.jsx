            ...
            <form ref={formRef} onSubmit={handleSubmit} className="glass rounded-2xl p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-5">
              ...
              {status === 'error' && (
                <motion.div
                  initial={{ opacity: 0, y: -8 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="flex items-center gap-1.5 sm:gap-2 text-red-400 bg-red-500/10 border border-red-500/20 rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm"
                >
